...
void RemotePixmapLabel::setRemotePixmap(const QString& url,QString fallbackUrlStr)
{
...
void RemotePixmapLabel::showRetry(const QString urlStr)
{
    deleteButtons();
    QByteArray data = QByteArray::fromBase64(reloadCIcon64.toLatin1());
...
void RemotePixmapLabel::deleteButtons()
{
